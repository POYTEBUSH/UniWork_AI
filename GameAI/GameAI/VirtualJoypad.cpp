...
void VirtualJoypad::ResetJoypadState()
{
	LeftArrow	= false;
	RightArrow	= false;
	UpArrow		= false;
...
/*
Uint8 joystickState = SDL_JoystickGetHat(mJoystick, 0);
if (joystickState & SDL_HAT_UP)
{
}
else if (joystickState & SDL_HAT_DOWN)
{
}

if (joystickState & SDL_HAT_LEFT)
{
}
else if (joystickState & SDL_HAT_RIGHT)
{
}
*/
//--------------------------------------------------------------------------------------------------